...
@section('content-layout')
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="about-desc">
                        ...
                        <p class="mb-20">Công ty TSMobile là một doanh nghiệp chuyên cung cấp các sản phẩm laptop chất lượng cao, phục vụ nhu cầu công nghệ của người dùng. TSMobile do ông Nguyen Huu Truong sở hữu và chính thức được thành lập vào ngày 1 tháng 1 năm 2024.</p>
                        <p class="mb-20">TSMobile cam kết mang đến cho khách hàng những dòng sản phẩm laptop đa dạng từ các thương hiệu nổi tiếng trên thế giới. Công ty không chỉ chú trọng đến chất lượng sản phẩm mà còn đặt khách hàng lên hàng đầu với dịch vụ hỗ trợ tận tình, chu đáo.</p>
                        <p class="mb-20">Các sản phẩm của TSMobile được chọn lọc kỹ càng để đảm bảo đáp ứng đầy đủ các tiêu chí về hiệu suất, độ bền và tính năng hiện đại. Bên cạnh việc cung cấp các dòng laptop mới, công ty còn cung cấp các dịch vụ bảo hành, sửa chữa và tư vấn kỹ thuật, nhằm đảm bảo rằng khách hàng sẽ luôn có được trải nghiệm tốt nhất khi sử dụng sản phẩm từ TSMobile.</p>
                        <p class="mb-20">Với sự lãnh đạo của ông Doãn Huy Việt, một người có tầm nhìn và kinh nghiệm trong lĩnh vực công nghệ, TSMobile đang dần khẳng định vị thế của mình trên thị trường, trở thành địa chỉ tin cậy cho những ai đang tìm kiếm các sản phẩm laptop chất lượng.</p>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-6">
                    <div class="single-team mb-all-30">
                        <div class="team-img sidebar-img">
                            ...
                            <div class="team-link">
                                <ul>
                                    <li><h6>TSMobile đặt tận tâm là nền tảng của phục vụ, lấy khách hàng làm trung tâm, mang đến những giá trị đích thực tới khách hàng và đối tác.</h6></li>
                                </ul>
                            </div>
                        </div>
                        <div class="team-info">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-6">
                    <div class="single-team mb-all-30">
                        <div class="team-img sidebar-img">
                            ...
                            <div class="team-link">
                                <ul>
                                    <li><h6>TSMobile đặt chữ TÍN lên hàng đầu, luôn thể hiện tinh thần trách nhiệm cao cùng phương châm “Làm hết việc chứ không làm hết giờ”.</h6></li>
                                </ul>
                            </div>
                        </div>
                        <div class="team-info">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-6">
                    <div class="single-team mb-xxs-30">
                        <div class="team-img sidebar-img">
                            ...
                            <div class="team-link">
                                <ul>
                                    <li><h6>TSMobile đặt sự khác biệt là chủ trương để xây dựng công ty thành một doanh nghiệp dẫn đầu.</h6></li>
                                </ul>
                            </div>
                        </div>
                        <div class="team-info">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-6">
                    <div class="single-team">
                        <div class="team-img sidebar-img">
                            ...
                            <div class="team-link">
                                <ul>
                                    <li><h6>TSMobile coi sáng tạo là đòn bẩy để phát triển, luôn đề cao các sáng kiến để hoàn thiện, hiệu quả hơn, nâng tầm giá trị.</h6></li>
                                </ul>
                            </div>
                        </div>
                        <div class="team-info">
    ...
    <div class="about-skill ptb-100 ptb-sm-60">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <h3 class="about-title mb-20">NHÂN SỰ TSMobile</h3>
                    ...
                    <div class="skill-progress mb-all-40">
                        ...
                        <div>
                            <p class="mb-20" class="lnr lnr-pointer-right">Công Ty Cổ Phần Đầu Tư Công Nghệ TSMobile sở hữu đội ngũ cán bộ, nhân viên, kỹ thuật viên lên đến trên 500 người với tay nghề kỹ thuật cao, giàu chuyên môn và kinh nghiệm.</p>
                        </div>
                        <div>
                            <p class="mb-20" class="lnr lnr-pointer-right">Mục tiêu của TSMobile là đem đến chất lượng sản phẩm và dịch vụ công nghệ hoàn hảo nhất, đáp ứng nhu cầu đa dạng của khách hàng, sản phẩm phù hợp tiêu chuẩn quốc tế.</p>
                        </div>
                        <div>
                            <p class="mb-20" class="lnr lnr-pointer-right">Với tiêu chí "Môi trường tốt tạo ra những giá trị tuyệt vời”, TSMobile luôn là đơn vị tiên phong xây dựng môi trường làm việc trẻ trung, năng động với chính sách phúc lợi và đãi ngộ hàng đầu cho đội ngũ CBNV.</p>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="ht-single-about">
                        <h3 class="about-title mb-20">HỆ THỐNG CÁC SHOWROOM CỦA TSMobile</h3>
                        <div class="ht-about-work">
                            <span>1</span>
                            <div class="ht-work-text">
                                <h5><a href="#">TSMobile - ĐÔNG SƠN</a></h5>
                                ...
                                <p><i class="lnr lnr-envelope"></i>Email: 1dongthinh@TSMobile</p>
