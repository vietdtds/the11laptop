 ...
 @section('content-ad')
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">{{ trans('home_ad.ql_dh') }} Chưa Duyệt</h6>
        </div>
            ...
            <table>
                <tr>
                    <form action="{{url('/export-excel-don-hang-chua-duyet')}}" method="POST">
                        ...
                        <button class="btn btn-outline-success" type="submit" name="export_dh_chua_duyet">
        ...
        <div class="card-body">
            <div class="table-responsive class-product">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" style="text-align: center;">
                    ...
                    <tbody>
                        @foreach($donhang_chuaduyet as $key => $dh)
                        <tr>
                            <td>{{$key+=1}}</td>
                            <td>{{$dh->name}}</td>
...
<!--                             <td>{{$dh->date_order}}</td>
                            ...
                            <td>
                                ...
                                <button class="btn btn-outline-danger delete" data-toggle="modal" data-target="#dhchuaduyetDel_{{$dh->id_bill}}" type="button"><i class="fas fa-trash-alt"></i></button>
                                <!-- </a> -->
                            </td>

                            <!-- Modal Delete-->
                            <div class="modal fade" id="dhchuaduyetDel_{{$dh->id_bill}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
