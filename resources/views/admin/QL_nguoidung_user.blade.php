                        ...
                        <tr>
                            ...
                            <td>
                                <!-- <a href="{{route('update_admin',$usr->id)}}"> -->
                                    <button class="btn btn-outline-primary edit" data-toggle="modal" data-target="#userUpdate_{{$usr->id}}" type="button"><i class="fas fa-pencil-alt"></i></button>
                                <!-- </a><br><br> -->
                                <!-- <a href="{{route('delete',$usr->id)}}"> -->
                                    <button class="btn btn-outline-danger delete" data-toggle="modal" data-target="#userDel_{{$usr->id}}" type="button"><i class="fas fa-trash-alt"></i></button>
                                <!-- </a> -->
                            </td>
