            ...
            <table>
                <tr>
                    <form action="{{url('/export-excel-don-hang-huy')}}" method="POST">
                        ...
                        <button class="btn btn-outline-success" type="submit" name="export_dh_huy">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-outline-danger delete" data-toggle="modal" data-target="#dhHuyDel_{{$dh->id_bill}}" type="button"><i class="fas fa-trash-alt"></i></button>
                                <!-- </a> -->
                            </td>
