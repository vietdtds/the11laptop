    ...
    <!-- jquery 3.2.1 -->
    <script src="<?php echo e(asset('source/assets/frontend/js/vendor/jquery-3.2.1.min.js')); ?>"></script>
    <!-- Countdown js -->
    <script src="<?php echo e(asset('source/assets/frontend/js/jquery.countdown.min.js')); ?>"></script>
    <!-- Mobile menu js -->
    <script src="<?php echo e(asset('source/assets/frontend/js/jquery.meanmenu.min.js')); ?>"></script>
    <!-- ScrollUp js -->
    <script src="<?php echo e(asset('source/assets/frontend/js/jquery.scrollUp.js')); ?>"></script>
    <!-- Nivo slider js -->
    <!-- <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.10.1/jquery.min.js"></script>  -->
    <script src="<?php echo e(asset('source/assets/frontend/js/jquery.nivo.slider.js')); ?>"></script>
    <script src="<?php echo e(asset('source/assets/frontend/js/jquery.nivo.slider.pack.js')); ?>"></script>
    <!-- Fancybox js -->
    <script src="<?php echo e(asset('source/assets/frontend/js/jquery.fancybox.min.js')); ?>"></script>
    <!-- Jquery nice select js -->
    <script src="<?php echo e(asset('source/assets/frontend/js/jquery.nice-select.min.js')); ?>"></script>
    <!-- Jquery ui price slider js -->
    <script src="<?php echo e(asset('source/assets/frontend/js/jquery-ui.min.js')); ?>"></script>
    <!-- Owl carousel -->
    <script src="<?php echo e(asset('source/assets/frontend/js/owl.carousel.min.js')); ?>"></script>
    <!-- Bootstrap popper js -->
    <script src="<?php echo e(asset('source/assets/frontend/js/popper.min.js')); ?>"></script>
    <!-- Bootstrap js -->
    <script src="<?php echo e(asset('source/assets/frontend/js/bootstrap.min.js')); ?>"></script>
    <!-- Plugin js -->
    <script src="<?php echo e(asset('source/assets/frontend/js/plugins.js')); ?>"></script>
    <!-- Main activaion js -->
    <script src="<?php echo e(asset('source/assets/frontend/js/main.js')); ?>"></script>

    <script src="<?php echo e(asset('source/assets/frontend/js/simple.money.format.js')); ?>"></script>

    <!-- Notification -->
    <script src="<?php echo e(asset('source/assets/dest/js/toastr.min.js')); ?>"></script>
    <script type="text/javascript">
    <?php if(session('thongbao')): ?>

        toastr.success('<?php echo e(session('thongbao')); ?>', '<?php echo e(trans('home.Notification')); ?>',{timeOut: 7000});

    <?php endif; ?>
    <?php if(session('thongbaoloi')): ?>

        toastr.error('<?php echo e(session('thongbaoloi')); ?>', '<?php echo e(trans('home.Notification')); ?>',{timeOut: 7000});

    <?php endif; ?>
    <?php if($errors->any()): ?>
      <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $err): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

        toastr.error('<?php echo e($err); ?>', '<?php echo e(trans('home.Notification')); ?>',{timeOut: 7000});
        ...
        for(i = 0; i<compare.length;i++){
          ...
          $('#td5').append(`
            <td class="product-description" id="del-td4`+id+`">
                <a class="compare-cart text-uppercase" href="`+url+`"> + <?php echo e(trans('home.addcart')); ?></a>
            </td>`
          );
          $('#td6').append(`
    ...
    function view(){
      if (!localStorage.getItem('data')){
        $('#count_wish').append(`
          ...
          <span class="my-cart" >
            <span><?php echo e(trans('home.yeu')); ?></span><span><?php echo e(trans('home.thich')); ?> (0)</span>
          </span>
        `);
      }
        ...
        if (data.length>0) {
              ...
              <div class="like-product ptb-95 off-white-bg pt-sm-50 pb-sm-55 " id="del-background`+id+`">
                  <div class="container" id="wish_top">
                      <div class="like-product-area" >
                          <h2 class="section-ttitle2 mb-30"><?php echo e(trans('home.like')); ?> </h2>
          ...
          $('#count_wish').append(`
            <i class="lnr lnr-heart"></i>
            <span class="my-cart" >
              <span><?php echo e(trans('home.yeu')); ?></span><span><?php echo e(trans('home.thich')); ?> (`+data.length+`)</span>
            </span>
          `);
            ...
            <div style="background: #fff" class="pro-content">
              ...
              <div class="pro-actions">
                  <div class="actions-primary">
                      <a href="`+url+`" title="<?php echo e(trans('home.addcart')); ?>">+ <?php echo e(trans('home.addcart')); ?></a>
                  </div>
...
<?php /**PATH C:\laragon\www\the11laptop\resources\views/FrontEnd/Style/Script.blade.php ENDPATH**/ ?>